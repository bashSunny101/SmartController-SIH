...
const alerts = [
  ...
  const logs = [
    { timestamp: '2023-01-22 09:20 AM', userId: 'admin', ip: '192.168.1.100', action: 'Login Success' },
    { timestamp: '2023-01-22 09:30 AM', userId: 'intruder', ip: '192.168.1.200', action: 'Login Failure' },
    { timestamp: '2023-01-22 09:30 AM', userId: 'intruder', ip: '192.168.1.200', action: 'Login Failure' },
    { timestamp: '2023-01-22 09:30 AM', userId: 'intruder', ip: '192.168.1.200', action: 'Login Failure' },
    { timestamp: '2023-01-22 09:30 AM', userId: 'intruder', ip: '192.168.1.200', action: 'Login Failure' },
    // ... more logs
...
function SecurityCenter() {
  return (
    <>
    <div className='container w-screen text-xl'>
    ...
    <div className="bg-gray-800 text-white p-4 rounded-lg mt-4">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-600">
          <thead>
            <tr>
              <th className="px-4 py-2 text-left text-md font-medium uppercase tracking-wider">Vulnerability Type</th>
              <th className="px-4 py-2 text-left text-md font-medium uppercase tracking-wider">Severity</th>
              <th className="px-4 py-2 text-left text-md font-medium uppercase tracking-wider">Incident Count</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-600">
            {alerts.map((alert, index) => (
              <tr key={index}>
                ...
                <td className="px-4 py-2 whitespace-nowrap">{alert.severity}</td>
                <td className="px-4 py-2 whitespace-nowrap">{alert.count}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div className="flex justify-end mt-4">
        <button className="text-lg py-2 px-4 border-2 rounded bg-gray-800 hover:bg-gray-600 focus:outline-none">View Detailed Security Alert Logs</button>
      </div>
    </div>   
    <div className="bg-gray-800 text-white p-4 rounded-lg mt-5">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-gray-500">Honeypot Alerts</h1>
        <div className="relative">
          <select className="bg-gray-700 text-white appearance-none py-2 px-4 rounded leading-tight focus:outline-none focus:bg-gray-600 focus:border-gray-500">
            <option>Last 24 Hours</option>
            <option>Last 7 Days</option>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-600">
          <thead>
            <tr>
              <th className="px-4 py-2 text-left text-md font-medium uppercase tracking-wider">Honeypot Type</th>
              <th className="px-4 py-2 text-left text-md font-medium uppercase tracking-wider">Severity</th>
              <th className="px-4 py-2 text-left text-md font-medium uppercase tracking-wider">Incident Count</th>
            </tr>
          </thead>
    ...
    <div className="bg-gray-800 p-4 text-white mt-5">
      ...
      <div className="overflow-x-auto mt-3">
        <table className="min-w-full">
          <thead>
            <tr>
              <th className="px-4 py-2 text-left text-md font-medium uppercase tracking-wider">Timestamp</th>
              <th className="px-4 py-2 text-left text-md font-medium uppercase tracking-wider">User ID</th>
              <th className="px-4 py-2 text-left text-md font-medium uppercase tracking-wider">IP Address</th>
              <th className="px-4 py-2 text-left text-md font-medium uppercase tracking-wider">Action</th>
            </tr>
          </thead>
          <tbody>
            {logs.map((log, index) => (
